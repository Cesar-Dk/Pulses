...
{
	if(handle_GPDMA1_Channel0.Instance == GPDMA1_Channel0) {
		HAL_DMA_DeInit(&handle_GPDMA1_Channel0);
	}
	if(handle_GPDMA1_Channel1.Instance == GPDMA1_Channel1) {
		HAL_DMA_DeInit(&handle_GPDMA1_Channel1);
	}
	if(handle_GPDMA1_Channel2.Instance == GPDMA1_Channel2) {
