...
#ifndef APPLICATION_MBUS_INC_MBUS_PROTOCOL_H_
#define APPLICATION_MBUS_INC_MBUS_PROTOCOL_H_
...
/**
 * @addtogroup MBUS_Protocol MBUS Protocol
 * @{
 */
...
/**
 * @struct _mbus_frame
 * @brief MBUS protocol frame
 */
typedef struct _mbus_frame {

    u_char start1;				/*!< start1 byte */
    u_char length1;				/*!< length LSByte  */
    u_char length2;				/*!< Length MSByte  */
    u_char start2;				/*!< start2 byte */
    u_char control;				/*!< control byte  */
    u_char address;				/*!< Address */
    u_char control_information;	/*!< control information  */
    // variable data field
    u_char checksum;			/*!< Checksum */
    u_char stop;				/*!< Stop byte*/

    u_char   data[252];			/*!< variable data field  */
...
/**
 * @brief MBUS Supported Handle types
 * @{
 */
...
// DATA RECORDS
/**
 * @brief MBUS FRAME DATA FORMATS. Data records
 * @{
 */
...
typedef struct _mbus_value_information_block {
        ...
        u_char custom_vif[128];//custom_vif[10];
...
//
//
#define MBUS_MAX_PRIMARY_SLAVES 30//250//256
...
#define MBUS_DATA_RECORD_DIF_MASK_MAX       0x10
#define MBUS_DATA_RECORD_DIF_MASK_MIN       0x20

#define MBUS_DATA_RECORD_DIF_MASK_TYPE_INT16     0x02
#define MBUS_DATA_RECORD_DIF_MASK_TYPE_INT32     0x04
#define MBUS_DATA_RECORD_DIF_MASK_TYPE_2DIGBCD   0x09
#define MBUS_DATA_RECORD_DIF_MASK_TYPE_4DIGBCD   0x0A
#define MBUS_DATA_RECORD_DIF_MASK_TYPE_6DIGBCD   0x0B
#define MBUS_DATA_RECORD_DIF_MASK_TYPE_8DIGBCD   0x0C
#define MBUS_DATA_RECORD_DIF_MASK_TYPE_VAR_LENGTH 0x0D
#define MBUS_DATA_RECORD_DIF_MASK_TYPE_12DIGBCD  0x0E
...
#define MBUS_DATA_RECORD_VIF_MASK_VOLUME         0x78
#define MBUS_DATA_RECORD_VIF_VOLUME              0x10
#define MBUS_DATA_RECORD_VIF_MASK_VOLUME_FLOW    0x78
#define MBUS_DATA_RECORD_VIF_VOLUME_FLOW         0x38
...
int    mbus_data_variable_parse_and_get_json(mbus_frame *frame, mbus_data_variable *data);
...
void mbus_data_tm_encode(time_t *t_time, u_char *t_data, size_t t_data_size);
...
int32_t mbus_frame_select_secondary_pack(mbus_frame *frame, char *address);

int32_t mbus_is_primary_address(int value);
int32_t mbus_is_secondary_address(const char * value);
...
#endif /* APPLICATION_MBUS_INC_MBUS_PROTOCOL_H_ */
