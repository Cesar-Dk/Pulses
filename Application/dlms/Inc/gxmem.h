...
#ifndef gxfree
#define gxfree(p)            mfree(p, (unsigned char *)__FILE__, __LINE__)
#endif

#ifndef gxmalloc
#define gxmalloc(s)          mmalloc(s, (unsigned char *)__FILE__, __LINE__)
#endif

#ifndef gxcalloc
#define gxcalloc(p, s)       mcalloc(p, s, (unsigned char *)__FILE__, __LINE__)
#endif

#ifndef gxrealloc
#define gxrealloc(p, s)      mrealloc(p, s, (unsigned char *)__FILE__, __LINE__)
#endif
#else
#ifndef gxfree
